function [ defPosition, defAngle] = extractDefectInfo (localOP, thisDefect, typeDefect,useCenter)
% 
...
if useCenter ==1
    row = round(mean(defRectPosition(2):end1));
    col = round(mean(defRectPosition(1):end2));
else
