function  displayFrameOrientation(thisFileImName, mainDir,mainDisplayDir, numImages)
...
for j=1:ntot,
    ...
    set(quiverFig(j),'Position',[50 400 imSize1 imSize2]); set(gca,'units','pixels'); % make the figure in original pixel size
