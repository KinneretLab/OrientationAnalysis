...
%              ridgeorient(im, gradientsigma, blocksigma, orientsmoothsigma,coherenceWinSize)
function [orientim, reliability,coherence1,coherence2] = ...
             ridgeorient(im, gradientsigma, blocksigma, orientsmoothsigma,coherenceWinSize)
    ...
    coherence1 = compute_coherence(orientim_orig, coherenceWinSize);
    ...
    coherence2 = compute_coherence(orientim, coherenceWinSize);
